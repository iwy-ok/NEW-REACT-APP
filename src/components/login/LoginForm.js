                ...
                <div className="form-container">
                    <form >
                        ...
                        <div className="input-container">
                            ...
                            <span style={{color: '#db7301'}}>{this.state.emailError}</span>
                        </div>
                        <div className="input-container">
                           ...
                           />
                            ...
                            <span style={{color: '#db7301'}}>{this.state.passwordError}</span>  
                        </div>
                        <div className="input-container">
                        ...
                        <label className="checkbox-container">
                            Remember me
                            <input type="checkbox" defautlChecked={this.state.checked} onChange={this.handlerCheckbox} />
